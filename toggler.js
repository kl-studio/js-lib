...
const toggler = {
    ...
    delete: (obj, sV)  => {
        (Array.isArray(obj)) ? obj.forEach(o => toggler.delete(o, sV)) : obj.removeAttribute(sV.name);
        if(!sV.body) { return true }
    ...
    toggle: (obj, sV = toggler.opt, callback = null) => {
        toggler.render(obj, sV);
        (Array.isArray(obj)) ? obj.forEach(objs => toggler.event(objs, sV, obj, callback)) : toggler.event(obj, sV, null, callback)
        return true
    },
